...
cd "C:\Users\cyrus\OneDrive\99. Archive\Old\Documents\2026\FIFA\June_Journal\2026fifaworldcup\June_22"

# 2. Create the list array
$files = @(
	"file '2026_062510_4.mp4'"
	"file '2026_062510_1.mp4'"
	"file '2026_062510_2.mp4'"
	"file '2026_062510_3.mp4'"
