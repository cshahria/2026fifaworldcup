...
cd "C:\Users\cyrus\OneDrive\99. Archive\Old\Documents\2026\FIFA\June_Journal\2026fifaworldcup\July_6"

# 2. Create the list array
$files = @(
	"file '2026_070739_1.mp4'"
	"file '2026_070739_2.mp4'"
	"file '2026_070739_3.mp4'"
	"file '2026_070739_4.mp4'"
	"file '2026_070739_5.mp4'"
