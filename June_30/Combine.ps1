...
cd "C:\Users\cyrus\OneDrive\99. Archive\Old\Documents\2026\FIFA\June_Journal\2026fifaworldcup\June_30"

# 2. Create the list array
$files = @(
    "file '2026_063010_3.mp4'"
    "file '2026_063010_4.mp4'"
    "file '2026_063010_5.mp4'"
    "file '2026_063010_6.mp4'"
    "file '2026_063010_1.mp4'"
    "file '2026_063010_2.mp4'"
    "file '2026_063049_1.mp4'"
)
...
ffmpeg -f concat -safe 0 -i inputs.txt -c copy trophy_day_June_30.mp4
