...
cd "C:\Users\cyrus\OneDrive\99. Archive\Old\Documents\2026\FIFA\June_Journal\2026fifaworldcup\June_14"

# 2. Create the list array
$files = @(
	"file '2026_061449_3.mp4'"
	"file '2026_061449_1.mp4'"
	"file '2026_061449_2.mp4'"
