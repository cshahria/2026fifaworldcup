...
cd "C:\Users\cyrus\OneDrive\99. Archive\Old\Documents\2026\FIFA\June_Journal\2026fifaworldcup\June_13"

# 2. Create the list array
$files = @(
	"file '2026_061350_7.mp4'"
	"file '2026_061350_2.mp4'"
	"file '2026_061350_3.mp4'"
	"file '2026_061350_4.mp4'"
	"file '2026_061350_5.mp4'"
	"file '2026_061350_6.mp4'"
