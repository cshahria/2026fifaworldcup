...
cd "C:\Users\cyrus\OneDrive\99. Archive\Old\Documents\2026\FIFA\June_Journal\2026fifaworldcup\June_19"

# 2. Create the list array
$files = @(
	"file '2026_062057_3.mp4'"
	"file '2026_062057_4.mp4'"
	"file '2026_062057_5.mp4'"
	"file '2026_062057_6.mp4'"
	"file '2026_062057_2.mp4'"
...
ffmpeg -f concat -safe 0 -i inputs.txt -c copy shift4.mp4
